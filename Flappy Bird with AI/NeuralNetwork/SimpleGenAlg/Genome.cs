...
namespace btl.generic
{
	...
	public class Genome
    {
		...
		[JsonConstructor]
		public Genome(double[] genes, int length, double fitness)
        {
            m_genes = genes;
            m_length = length;
            m_fitness = fitness;
		...
		[JsonProperty] public double[] m_genes;
		[JsonProperty] private int m_length;
		[JsonProperty] private double m_fitness;
